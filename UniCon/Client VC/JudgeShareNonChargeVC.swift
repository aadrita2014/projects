...
class JudgeShareNonChargeVC: UIViewController {
    ...
    @IBOutlet weak var reachWhenChargingShareTf: UITextField!
    ...
    func setupView()   {
        ...
        bgView4.addDarkGrayBackgroundColor()
        bgView4.addCornerRadius()
        ...
        reachWhenChargingShareTf.updatePlaceHolder(text: "000", color: AppColors.default_red_color)
        reachWhenChargingShareTf.addBottomBorder(color: UIColor.lightGray)
